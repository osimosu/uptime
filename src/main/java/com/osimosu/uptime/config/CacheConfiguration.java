package com.osimosu.uptime.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.osimosu.uptime.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.osimosu.uptime.repository.UserRepository.USERS_BY_EMAIL_CACHE);
